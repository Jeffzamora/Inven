...
class SerieForm(forms.ModelForm):
    ...
    Area = forms.CharField(max_length=300, label="Sede", required=False, widget=forms.TextInput(
        attrs={
            'readonly': 'readonly'
        }
    ))

    Proceso = forms.CharField(max_length=300, label="Sede", required=False, widget=forms.TextInput(
        attrs={
            'readonly': 'readonly'
        }
    ))
