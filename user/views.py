...
#
# from custodia.mixins import ValidatePermissionRequiredMixin
# from custodia.user.forms import UserForm, UserProfileForm
# from custodia.user.models import User
#
#
...
#         context['create_url'] = reverse_lazy('administracion:user_create')
#         context['list_url'] = reverse_lazy('administracion:user_list')
...
#         except:
#             pass
#         return HttpResponseRedirect(reverse_lazy('inventario:dashboard'))
#
#
